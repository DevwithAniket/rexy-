...
const App = () => {
   ...
   * and 'toggleSidebar' is used to toggle the sidebar.
   */
  const [isSidebarOpen, toggleSidebar] = useToggle();

  /**
   * Access the prompt preloader state,
   * Particularly the value for the prompt preloading
   */
  ...
  return (
    <>
      {/* Meta Title */}
      <PageTitle title='Rexy | Chat to Boost your Imagination' />
        ...
        <div className='h-dvh grid grid-rows-[max-content,minmax(0,1fr),max-content]'>
          ...
          <div className='bg-light-background dark:bg-dark-background'>
            <div className='max-w-[870px] px-5 w-full mx-auto'>
              ...
              >
                Rexy may make mistakes. Check for important information.
                <a
