...
const PromptField = () => {
  ...
  //Retrieve the conversationId from the url path
  ...
  //Move cursor to the end of the input field after pasting a text
  const moveCursorToEnd = useCallback(() => {
    const editableElem = inputField.current;
    const range = document.createRange();
    const selection = window.getSelection();

    //Set the range tio the last child of the editable element
  ...
  //Define a Framer Motion variant for the prompt field, controlling its animation based on its visibility state.
  ...
  //Define a Framer Motion variant for the prompt field children, controlling its animation basied on its visibility state.
