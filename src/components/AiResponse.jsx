...
const AiResponse = ({ aiResponse, children }) => {
  ...
  //Use useEffect to detect the changes in the user's preferred color scheme
  useEffect(() => {
    ...
    //Cleanup function to remove the event listener when the components unmounts.
  ...
  //This function will executre for every code tag
